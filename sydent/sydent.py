...
class Servlets:
    def __init__(self, sydent: Sydent, lookup_pepper: str):
        ...
        self.emailRequestCodeV2 = EmailRequestCodeServlet(self, require_auth=True)
        self.emailValidate = EmailValidateCodeServlet(sydent)
        self.emailValidateV2 = EmailValidateCodeServlet(self, require_auth=True)
        self.msisdnRequestCode = MsisdnRequestCodeServlet(sydent)
        self.msisdnRequestCodeV2 = MsisdnRequestCodeServlet(self, require_auth=True)
        self.msisdnValidate = MsisdnValidateCodeServlet(sydent)
        self.msisdnValidateV2 = MsisdnValidateCodeServlet(self, require_auth=True)
        ...
        self.getValidated3pidV2 = GetValidated3pidServlet(self, require_auth=True)
