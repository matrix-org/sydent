...
# this script updates the database but does not send any emails

def update_local_associations_no_email(sydent, db: sqlite3.Connection):
...
def update_global_assoc_no_email(sydent, db: sqlite3.Connection):
...
if __name__ == "__main__":
    ...
    update_global_assoc_no_email(sydent, sydent.db)
    update_local_associations_no_email(sydent, sydent.db)